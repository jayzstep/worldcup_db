...
# had to look this up, didn't know about using OR after ON. I was trying AND, but couldn't get it to work. Source: https://forum.freecodecamp.org/t/worldcup-queries/507435
